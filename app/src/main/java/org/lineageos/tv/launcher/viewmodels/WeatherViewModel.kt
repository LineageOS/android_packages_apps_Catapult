...
class WeatherViewModel : ViewModel() {
    private val weatherService =
        OpenWeatherClient("https://api.openweathermap.org/", "218f8f2cc4f1041af87f0cf1c8b602fd")
...
//            dataSource.currentWeather("Tampere").collect { status ->
//                when (status) {
//                    is RequestStatus.Success -> _weatherStatus.value = status
//                    is RequestStatus.Error -> println("Error: ${status.error}")
//                    is RequestStatus.Loading -> TODO()
//                }
//            }
        }
    }
