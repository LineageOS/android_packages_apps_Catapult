...
class AddWidgetItemView @JvmOverloads constructor(
    ...
    fun setCardInfo(widgetInfo: Widget) {
        widgetId = widgetInfo.id
        nameView.text = widgetInfo.label
        iconView.setImageDrawable(widgetInfo.icon)
    }
}
